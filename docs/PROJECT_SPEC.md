...
- Three header boxes — Number, Mode, Amount — plus a 4x4 numeric keypad (7/8/9/R, 4/5/6//, 1/2/3/ENTER, 0/00/000/Clear) and a row of 8 pattern-mode tabs: **အပါ, ထိပ်, နောက်, ပါ၀ါ, ဘရိတ်, နက္ခတ်, ခွေ, အပူး**.
- **Straight** (default, no tab selected, mode box shows "ဒဲ့"): type a 1-2 digit number (or several separated by `/`, e.g. `12/34/56`), set an amount, ENTER adds it to the pending list. Amount stays sticky after ENTER (matches the recording); Number and Mode reset.
...
- **ပါ၀ါ (power)**, **နက္ခတ် (nekkhat)**, **အပူး (twin)**: fixed 10-number lists, no digit input needed — just set an amount and ENTER/OK. ပါ၀ါ = 05,16,27,38,49,50,61,72,83,94. နက္ခတ် = 07,18,24,35,42,53,69,70,81,96. အပူး = 00,11,22,33,44,55,66,77,88,99 (the double/twin numbers).
